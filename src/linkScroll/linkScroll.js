export const linkScroll = (duration = 1000) => {
  ...
  function smoothScroll(tr) {
    ...
    function animation(currentTime) {
      ...
      let timeElapsed = currentTime - startTime,
        run = ease(timeElapsed, stratPosition, distance);
    ...
    function ease(timeElapsed, stratPosition, distance) { 
